...
const PillNav: React.FC<PillNavProps> = ({
    ...
    return (
        <div className={`relative z-[100] w-full left-0 md:w-auto md:left-auto ${className}`}>
            <nav
                className="w-full md:w-max flex items-center justify-between md:justify-start box-border px-4 md:px-0 mx-auto"
                aria-label="Primary"
                style={cssVars}
            >
                {isRouterLink(items?.[0]?.href) ? (
                    ...
                    >
                        {logo ? (
                            ...
                            <svg ref={logoImgRef as React.RefObject<SVGSVGElement>} className="h-5 w-5 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                ...
                >
                    ...
                    >
                        {items.map((item, i) => {
                            if (i === 0) return null; // Skip home since it's the logo
