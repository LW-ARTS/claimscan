...
// import { splitVaultHandler } from '@/lib/platforms/flap-vaults/split-vault';  // Plan 04 creates this
...
describe('SV-02: splitVaultHandler — userBalances tuple decode + invariant guard', () => {
  it.todo('readClaimable returns accumulated - claimed when accumulated > claimed (mock [1000n, 300n] -> 700n)');
  it.todo('readClaimable returns 0n when accumulated == claimed (steady-state, dispatched)');
  it.todo('readClaimable returns 0n on bscClient.readContract rejection (does not throw)');
});
