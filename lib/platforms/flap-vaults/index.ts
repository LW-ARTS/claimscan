...
// Phase 13 r1: lookupVaultAddress + TRY_GET_VAULT_SELECTOR moved to ./vault-portal
// to break a circular import with ./fund-recipient (index.ts re-exports
// detectFundRecipient from ./fund-recipient, and fund-recipient.ts calls
// lookupVaultAddress; sourcing the lookup from ./vault-portal keeps the dependency
// DAG acyclic). Re-exported here so existing consumers (cron, classify-flap.ts,
